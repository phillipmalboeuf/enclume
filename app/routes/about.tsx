      ...
      <main className='blue_back' role='main'>
        ...
        <div className='padded padded--big_top'>
          ...
          <OnScroll className='grid grid--guttered'>
            ...
            {this.context.content.about.fields.teamMembers.filter((member: any)=> member.fields).map((member: { fields: any, sys: { id: string } })=> <div key={member.sys.id} className='col col--4of12 col--tablet_landscape--6of12'>
